...
export SERVER_LOG_PATH=/var/log/dss-flow-execution-entrance
...
then
  export SERVER_JAVA_OPTS=" -Xmx$SERVER_HEAP_SIZE -XX:+UseG1GC -Xloggc:$SERVER_LOG_PATH/logs/linkis-gc.log"
fi
